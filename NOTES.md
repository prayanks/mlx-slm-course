...
- Visual system: **Silicon Lab** — Instrument Sans + Newsreader + IBM Plex Mono; electric blue/indigo accent on cool slate paper; light+dark via prefers-color-scheme. Shared CSS in `assets/lesson.css`. Distinct from other courses.
